...
{ 
    public class TarifaController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            return PartialView("_CreateTarifa");
        }
        ...
        public ActionResult Create(Tarifa tarifa)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    var dbTarifa = db.Tarifa.Where(g => g.descripcion == tarifa.descripcion).SingleOrDefault();
                    return Json(new { Tarifa = dbTarifa, Error = string.Empty });
                }
                else
                {
